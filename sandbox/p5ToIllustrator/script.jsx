...
function addPath() {
    ...
    curvePoint.anchor = Array(300, 300);
    curvePoint.leftDirection = Array(240, 300);
    curvePoint.rightDirection = Array(360, 300);
    curvePoint.pointType = PointType.SMOOTH;

    var curvePoint2 = curve.pathPoints.add();
    curvePoint2.anchor = Array(400, 100);
    curvePoint2.leftDirection = Array(340, 100);
    curvePoint2.rightDirection = Array(460, 100);
    curvePoint2.pointType = PointType.CORNER;

    var curvePoint3 = curve.pathPoints.add();
    curvePoint3.anchor = Array(500, 300);
    curvePoint3.leftDirection = Array(440, 300);
    curvePoint3.rightDirection = Array(660, 300);
...
var edge = {
    ...
    "vSource": {
        ...
        "nodeAttributes": {
            ...
            "Photograph": "https://archon.library.illinois.edu/index.php?p=digitallibrary/digitalcontent&id=8091",
            "Faculty_Staff_Graduate_Undergrad": "Faculty",
            "Current Faculty research": "Erhan Kudeki? https://ece.illinois.edu/about/directory/faculty/erhan",
            "Gender": " ",
            "Other": " "
        },
        "connectors": [
